...
namespace Vad.Reef.Logic.Home
{
    public class LogicClientHome : LogicBase
    {
        ...
        public override void Encode(ChecksumEncoder encoder)
        {
            ...
            encoder.WriteString(this._homeBaseLevel);
            encoder.WriteInt(this._shieldDurationSeconds);
            encoder.WriteInt(this._defenseRating);
            encoder.WriteInt(this._defenseKFactor);
        }
